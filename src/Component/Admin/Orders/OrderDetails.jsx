...
// import { Country, State, City } from 'country-state-city'; import axios from 'axios';
...
//                                                     <i className="ri-information-2-line font-18 align-middle me-1"></i>
...
//                                                     <i className="ri-truck-line font-18 align-middle me-1"></i>
...
//                                                     <span className="d-none d-sm-inline">Order Notes</span>
//                                                 </a>
//                                             </li>
//                                             <li className="nav-item">
//                                                 <a href="#basictab4" data-bs-toggle="tab" data-toggle="tab" className="nav-link rounded-0 py-2">

//                                                     <i className="ri-currency-line font-18 align-middle me-1"></i>
...
//                                                         <div className="mb-3">
//                                                             <label for="simpleinput" className="form-label">Order Id</label>
//                                                             <input type="text" id="simpleinput" className="form-control" value={getOrderDetails?._id} readOnly/>
//                                                         </div>
//                                                     </div>
//                                                     <div className="col-lg-4 col-md-4 col-sm-6 col-6">
//                                                         <div className="mb-3">
//                                                             <label for="simpleinput1" className="form-label">Order Number</label>
//                                                             <input type="text" id="simpleinput1" className="form-control" value={getOrderDetails?.OrderNumber} readOnly/>
//                                                         </div>
//                                                     </div>
//                                                     <div className="col-lg-4 col-md-4 col-sm-6 col-6">
//                                                         <div className="mb-3">
//                                                             <label for="simpleinput2" className="form-label">Order Status</label>
//                                                             <input type="text" id="simpleinput2" className="form-control"  value={getOrderDetails?.Status} readOnly />
//                                                         </div>
//                                                     </div>
//                                                     <div className="col-lg-4 col-md-4 col-sm-6 col-6">
//                                                         <div className="mb-3">
//                                                             <label for="simpleinput3" className="form-label">Customer</label>
//                                                             <input type="text" id="simpleinput3" className="form-control"  value={getOrderDetails?.UserID?.name} readOnly />
//                                                         </div>
//                                                     </div>
//                                                     <div className="col-lg-4 col-md-4 col-sm-6 col-6">
//                                                         <div className="mb-3">
//                                                             <label for="simpleinput4" className="form-label">Order Date</label>
//                                                             <input type="text" id="simpleinput4" className="form-control"  value={getOrderDetails?.createdAt ? format(new Date(getOrderDetails?.createdAt), 'PPP') : 'N/A'} readOnly/>
//                                                         </div>
//                                                     </div>
//                                                     <div className="col-lg-4 col-md-4 col-sm-6 col-6">
//                                                         <div className="mb-3">
//                                                             <label for="simpleinput5" className="form-label">Order Total</label>
//                                                             <input type="text" id="simpleinput5" className="form-control"value={`₹${getOrderDetails?.totalOrderPrice}`} readOnly />
//                                                         </div>
//                                                     </div>
//                                                 </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="mb-3">
                                                ...
                                                <input type="text" className="form-control" value={getOrderDetails?.UserID?.address} readOnly />
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="mb-3">
